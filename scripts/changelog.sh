...
script__usage() {
  ...
  echo -e "  $ansi_yellow plain  $ansi_magenta < file > $ansi_reset - generate a plain changelog"
  echo -e "  $ansi_yellow tagged $ansi_magenta < file > $ansi_reset - generate a tagged changelog"
  echo -e ""
