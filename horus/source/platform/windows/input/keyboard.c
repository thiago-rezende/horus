...
static const keyboard_keycode_t platform_input_keyboard_keycode_mapping[PLATFORM_INPUT_KEYBOARD_KEYCODE_COUNT] = {
    ...
    /* numpad */
    [VK_NUMPAD0] = KEYBOARD_KEYCODE_NUMPAD_0,
    [VK_NUMPAD1] = KEYBOARD_KEYCODE_NUMPAD_1,
    [VK_NUMPAD2] = KEYBOARD_KEYCODE_NUMPAD_2,
    [VK_NUMPAD3] = KEYBOARD_KEYCODE_NUMPAD_3,
    [VK_NUMPAD4] = KEYBOARD_KEYCODE_NUMPAD_4,
    [VK_NUMPAD5] = KEYBOARD_KEYCODE_NUMPAD_5,
    [VK_NUMPAD6] = KEYBOARD_KEYCODE_NUMPAD_6,
    [VK_NUMPAD7] = KEYBOARD_KEYCODE_NUMPAD_7,
    [VK_NUMPAD8] = KEYBOARD_KEYCODE_NUMPAD_8,
    [VK_NUMPAD9] = KEYBOARD_KEYCODE_NUMPAD_9,
    [VK_ADD] = KEYBOARD_KEYCODE_NUMPAD_ADD,
    /* [VK_RETURN] = KEYBOARD_KEYCODE_NUMPAD_ENTER, */ /* same virutal key as KEYBOARD_KEYCODE_ENTER */
    [VK_DIVIDE] = KEYBOARD_KEYCODE_NUMPAD_DIVIDE,
    [VK_DECIMAL] = KEYBOARD_KEYCODE_NUMPAD_DECIMAL,
    [VK_MULTIPLY] = KEYBOARD_KEYCODE_NUMPAD_MULTIPLY,
    [VK_SUBTRACT] = KEYBOARD_KEYCODE_NUMPAD_SUBTRACT,
};
...
static const keyboard_keycode_t platform_input_keyboard_scancode_mapping[0xFFFF] = {
    ...
    /* general */
    [0xE045] = KEYBOARD_KEYCODE_NUMLOCK,
    ...
    /* numpad */
    [0x0052] = KEYBOARD_KEYCODE_NUMPAD_0,
    [0x004F] = KEYBOARD_KEYCODE_NUMPAD_1,
    [0x0050] = KEYBOARD_KEYCODE_NUMPAD_2,
    [0x0051] = KEYBOARD_KEYCODE_NUMPAD_3,
    [0x004B] = KEYBOARD_KEYCODE_NUMPAD_4,
    [0x004C] = KEYBOARD_KEYCODE_NUMPAD_5,
    [0x004D] = KEYBOARD_KEYCODE_NUMPAD_6,
    [0x0047] = KEYBOARD_KEYCODE_NUMPAD_7,
    [0x0048] = KEYBOARD_KEYCODE_NUMPAD_8,
    [0x0049] = KEYBOARD_KEYCODE_NUMPAD_9,
    [0x004E] = KEYBOARD_KEYCODE_NUMPAD_ADD,
    [0xE01C] = KEYBOARD_KEYCODE_NUMPAD_ENTER,
    [0xE035] = KEYBOARD_KEYCODE_NUMPAD_DIVIDE,
    [0x0053] = KEYBOARD_KEYCODE_NUMPAD_DECIMAL,
    [0x0037] = KEYBOARD_KEYCODE_NUMPAD_MULTIPLY,
    [0x004A] = KEYBOARD_KEYCODE_NUMPAD_SUBTRACT,
};
...
keyboard_keycode_t __platform_input_keyboard_keycode(WPARAM virtual_key, LPARAM parameters) {
  ...
  switch (virtual_key) {
    ...
    case VK_RETURN: {
      return is_extended_key ? KEYBOARD_KEYCODE_NUMPAD_ENTER : KEYBOARD_KEYCODE_ENTER;
    }
