...
#define PLATFORM_MOUSE_BUTTON_COUNT 256

static const mouse_button_t platform_mouse_button_mapping[PLATFORM_MOUSE_BUTTON_COUNT] = {
    [0] = MOUSE_BUTTON_NONE,          /* */
    [1] = MOUSE_BUTTON_LEFT,          /* */
...
static const mouse_scroll_direction_t platform_mouse_scroll_direction_mapping[PLATFORM_MOUSE_BUTTON_COUNT] = {
    ...
    [6] = MOUSE_SCROLL_DIRECTION_LEFT,   /* */
    [7] = MOUSE_SCROLL_DIRECTION_RIGHT,  /* */
...
mouse_button_t platform_mouse_button(xcb_button_t button) {
  return platform_mouse_button_mapping[button];
}

mouse_scroll_direction_t platform_mouse_scroll_direction(xcb_button_t button) {
  return platform_mouse_scroll_direction_mapping[button];
}
