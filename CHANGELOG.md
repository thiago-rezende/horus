...
## [Unreleased]
 ...
 - [60b6aa3] ci(linux): add libgl1-mesa-dev installation on all linux setup steps (Thiago Rezende)
 - [d09e5d6] ci: add clang-tidy call on lint step for windows and linux workflows (Thiago Rezende)
 - [173ab31] chore(shaders): downgrade the spir-v version from 1.4 to 1.3 since it was causing segfault on linux with radv drivers (Thiago Rezende)
 - [b4ac14b] chore(sandbox): update screenshot to show the current OpenGL rendere state (Thiago Rezende)
 - [63727fd] feat(renderer|opengl): update default texture mipmap bias so enforce more quality (Thiago Rezende)
 - [d70c494] feat(renderer|opengl): add texture implementations and enable srgb colorspace for framebuffer (Thiago Rezende)
 - [c5b7c57] fix(renderer|opengl): update uniform buffer data to GL_DYNAMIC_DRAW and fetch renderer information after context creation (Thiago Rezende)
 - [7ec27bd] feat(renderer|opengl): add ktx OpenGL function loader call during context creation (Thiago Rezende)
 - [6ef67b9] feat(renderer|opengl): add global vertex array object to be used during the lifetime of the renderer (Thiago Rezende)
 - [640f516] feat(renderer|opengl): add instance buffer implementation (Thiago Rezende)
 - [dc91f83] feat(renderer|opengl): add uniform buffer implementation (Thiago Rezende)
 - [0164291] feat(renderer|opengl): add vertex attributes to vertex buffer implementation (Thiago Rezende)
 - [8c3b1ab] test(math): update matrix cases to disable Y-axis flip (Thiago Rezende)
 - [8d4fb1b] chore(math): disable Y-axis flip for now since it will only be required on vulkan (Thiago Rezende)
 - [ef758e8] fix(renderer|opengl): update shader program naming on pipeline bind procedure (Thiago Rezende)
 - [1e80a39] refactor(renderer|opengl): remove redundant 'shader' prefixes from shader_module_t (Thiago Rezende)
 - [1320761] docs(changelog): update CHANGELOG.md (Thiago Rezende)
 - [60bbf1c] feat(renderer|opengl): add OpenGL index buffer implementation (Thiago Rezende)
 - [11f1798] feat(renderer|opengl): add OpenGL vertex buffer implementation (Thiago Rezende)
 - [6e033be] feat(shaders|opengl): add OpenGL shader module implementation for SPIR-V shaders loading (Thiago Rezende)
 - [6655540] fix(renderer|windows): update ReleaseDC arguments to the corret placeholder ones (Thiago Rezende)
 - [564d535] chore: remove unnecessary cross-compilation files and update vscode tasks (Thiago Rezende)
 - [33723ef] fix(renderer|windows): add DestroyWindow call on SetPixelFormat failure during placeholder context creation (Thiago Rezende)
 - [834b155] refactor(renderer|windows): simplify SetPixelFormat call and add error handling to placeholder window SetPixelFormat call (Thiago Rezende)
 - [c694d3a] feat(renderer): improve OpenGL debug callback configuration (Thiago Rezende)
 - [eada1c0] feat(renderer): add and enable OpenGL debug callback function on linux and windows (Thiago Rezende)
 - [ecef8ad] chore(renderer|linux): remove unnecessary TODO comment on context_attributes (Thiago Rezende)
 - [204b3e5] refactor(renderer|windows): update OpenGL context creation to use wglChoosePixelFormatARB instead of ChoosePixelFormat (Thiago Rezende)
 - [1fce006] feat(renderer|linux): add OpenGL context creation with EGL (Thiago Rezende)
 - [74ebdef] chore(vscode): add MSYS CLANG64 as default integrated terminal on windows (Thiago Rezende)
 - [e4d9867] chore(renderer): add EGL_EXT_platform_xcb extension to EGL loader (Thiago Rezende)
 - [a3684cd] ci: remove unnecessary vulkan dependencies and update renderer paths (Thiago Rezende)
 - [df12e96] fix(renderer|windows): update glad headers inclusion on platform.c to point to the correct files (Thiago Rezende)
 - [896ba62] refactor: drop vulkan in favor of opengl with initial context creations and functions loading (Thiago Rezende)
 - [de87a43] chore(vscode): update extension recommendations (Thiago Rezende)
 - [6b4947e] revert(d8b7c36): bring back meson build system (Thiago Rezende)
 - [b043d0a] build(glad): update varibale names to prevent conflicts on glad package wrapper (Thiago Rezende)
 - [11143b5] build(glad): add custom package wrapper for glad on version 2 (Thiago Rezende)
 - [3b714c7] build(renderer|windows): remove unnecessary extensions from glad loader (Thiago Rezende)
 - [d36d307] feat(renderer|windows): enable vsync by default during context creation (Thiago Rezende)
 - [1a0a9d0] feat(renderer|windows): create modern OpenGL context with core profile and add default clear color (Thiago Rezende)
 - [21bd9e2] build(renderer): merge glad gl glx and wgl dependencies (Thiago Rezende)
 - [eab9d23] build(renderer): add glad with glx and wgl apis and opengl dependencies (Thiago Rezende)
 - [a762e41] refactor(renderer): removed vulkan implementation and add placeholder opengl implementation (Thiago Rezende)
 - [0943136] merge: branch 'main' into 'feature/opengl' (Thiago Rezende)
 - [5d8189f] chore(vscode): fix linux sandbox launch options to point to the correct path and executable (Thiago Rezende)
 - [b2c8958] docs(changelog): update CHANGELOG.md file (Thiago Rezende)
 - [a12e034] docs(readmes): update xmake badge label to Xmake (Thiago Rezende)
 - [b3db7af] docs(readme): drop vulkan citations in favor of opengl since for now the renderer will be implemented in opengl (Thiago Rezende)
 ...
 - [1f42dfd] ci(xmake): remove unnecessary -y argument on build and test xmake targets (Thiago Rezende)
 - [4d43652] ci(windows): update default toolchain to clang-cl during xmake configuration (Thiago Rezende)
 - [2bf1469] ci(xmake): update build system to xmake on build and test steps for windows (Thiago Rezende)
 - [ab99a50] ci: temparary disable of branch filtering for testing purposes (Thiago Rezende)
 - [2c65ca3] ci(xmake): update build system to xmake on build and test steps (Thiago Rezende)
 - [a562a49] build(assets): add custom xmake rule for building the project assets (Thiago Rezende)
 - [dec7392] build: add default options to enable or disable sandbox and tests build (Thiago Rezende)
 - [d8b7c36] chore(build): remove meson build system in favor of xmake (Thiago Rezende)
 - [c575c3f] feat(renderer): add initial material_t definition and its interface (Thiago Rezende)
 - [5670420] chore: update build config and solve some unsafe function calls for future switch to msvc on windows (Thiago Rezende)
 - [0f0527d] refactor(configuration): remove falty framerate limiter for favor of default renderer vsync option (Thiago Rezende)
 - [2aa8002] docs(changelog): update CHANGELOG.md (Thiago Rezende)
 ...
 - [98040a1] feat(renderer|vulkan): update texture implementation to handle compressed ktx2 formats and apply proper transcoding in runtime (Thiago Rezende)
 - [773a5cf] docs: update the sandbox screenshot to show texture mapping support (Thiago Rezende)
 - [e1fa3fc] feat(renderer): add texture sampler binding routine and sample it during the fragment stage (Thiago Rezende)
 - [11ae877] chore(renderer|vulkan): update index and vertex buffer queue submission failure message (Thiago Rezende)
 - [a7d26ea] fix(build|windows): update ktx library search method to use the compiler find_library routine (Thiago Rezende)
 - [13bb5a9] feat(renderer): begin texture mapping implementation with loading from ktx2 filen and its vulkan implementation (Thiago Rezende)
 - [d639dc3] fix(renderer|vulkan): update index and vertex buffers creation to properly handle resourcse release on error and update the command buffer usage (Thiago Rezende)
 - [14a8c68] feat(input|windows): update keyboard input system to handle numpad keys and its windows implementation (Thiago Rezende)
 - [ba27b19] chore(build): add simple Makefile with utility targets (Thiago Rezende)
 - [7b28238] chore(setup): add general assets management to setup.sh script (Thiago Rezende)
 - [de14836] chore(scripts): update assetse scrips to handle image to ktx conversion (Thiago Rezende)
 - [0afb0c9] chore(assets): add default checker textures with dark and light variants (Thiago Rezende)
 - [7bd19dd] feat(vertex): update vertex_t to contain the UV coordinates and update its vulkan implementation (Thiago Rezende)
 - [a3bb142] feat(sandbox): add camera rotation controls to show the improved camera implementation (Thiago Rezende)
 - [65bccb2] docs(changelog): update CHANGELOG.md (Thiago Rezende)
